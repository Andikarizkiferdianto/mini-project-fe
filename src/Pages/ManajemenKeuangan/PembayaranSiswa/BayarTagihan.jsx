                        ...
                        <div className="p-4 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select className="w-full border border-gray-200 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-200 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400"
                                    />
                                </div>
