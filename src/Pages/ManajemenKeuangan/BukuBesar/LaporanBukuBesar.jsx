                        ...
                        <table className="min-w-full text-sm">
                            <thead className="bg-violet-600 text-white">
                                <tr>
                                    ...
                                    <th className="py-2 px-3 text-right">Total Debit (Rp)</th>
                                    <th className="py-2 px-3 text-right">Total Kredit (Rp)</th>
                                    <th className="py-2 px-3 text-right">Total Saldo (Rp)</th>
                                </tr>
                            </thead>
