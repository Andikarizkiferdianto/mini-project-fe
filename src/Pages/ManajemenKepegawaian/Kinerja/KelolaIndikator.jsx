            ...
            <div className="flex-1 p-6 md:p-8 mt-12">
                    <div className="bg-violet-600 p-3 rounded-t-lg flex justify-between items-center shadow-md">
                        <h2 className="text-white font-semibold flex items-center gap-2">
                            <i className="ri-list-check text-xl"></i> Kelola Idikator Kerja
                        </h2>
                    <button className="bg-white text-black font-semibold text-sm px-3 py-2 rounded flex items-center gap-1 hover:bg-gray-100 transition">
                        ...
                        <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                            <thead className="bg-violet-600 text-white text-center">
                                <tr>
                                    ...
                                    <th className="p-3">Nama Indikator</th>
