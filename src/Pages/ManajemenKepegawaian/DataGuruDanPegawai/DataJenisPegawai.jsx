            ...
            <div className="flex-1 p-6 md:p-8 mt-12">
                ...
                <div className="bg-white p-4 shadow rounded-b-lg border border-gray-200">
                    ...
                    <div className="flex w-full mb-6 border border-violet-600 rounded overflow-hidden">
                        <button
                            onClick={() => navigate("/manajemen-kepegawaian/data-guru")} // PINDAH KE PAGE PEGAWAI
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-bold flex justify-center items-center gap-2 transition ${activeTab === 'pegawai' ? 'bg-violet-600 text-white' : 'bg-white text-violet-600'}`}
                        >
