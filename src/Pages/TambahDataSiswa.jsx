...
const TambahDataSiswa = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!form.nis || !form.nama || !form.tgl_lahir) {
    ...
    <div className="flex-1 p-6">
        <div className="bg-white rounded shadow overflow-hidden">
            ...
            <div className="p-6">
                ...
                {/* DATA SISWA */}
                <h2 className="font-semibold mb-3 text-gray-700">Data Siswa</h2>
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <input name="nama_wali" placeholder="Nama Wali" onChange={handleChange} className="border p-2 rounded" />
                    ...
                    <input name="hubungan_wali" placeholder="Hubungan Wali" onChange={handleChange} className="border p-2 rounded" />
                    ...
                    <input name="no_hp_wali" placeholder="No HP Wali" onChange={handleChange} className="border p-2 rounded" />
